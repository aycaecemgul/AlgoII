...
public class Deneme {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ArrayList<GeometrikNesne> dizi = new ArrayList<>();
        
        try{
           File file = new File("C:\\Users\\aycae\\OneDrive\\Belgeler\\NetBeansProjects\\Vize\\build\\classes\\vize\\input.txt"); //TODO: change this to input.txt
           ...
           while (file_scanner.hasNextLine()) {       
                ...
                if(sekil.equals("daire")){ //nextline daire nesnesi ise
                    ...
                    String date_or_not = file_scanner.next();
                    if(date_or_not.equals("date")){ // next string date ise true dondurur ve gelecek int ay bilgisi olarak alınır
                        
                        month = file_scanner.nextInt();
                        day = file_scanner.nextInt();
                        year= file_scanner.nextInt();
                    }
                    else{ // next string date degilse date_or_not stringi int'e cevrilir 
                        month = Integer.parseInt(date_or_not);
                        day = file_scanner.nextInt();
                        year= file_scanner.nextInt();    
                    }
        ...
        Daire dai2 = (Daire) dizi.get(2);
        
        Daire dai3=(Daire) dizi.get(3);
        Daire dai4 = new Daire(dai3); //copy constructor
        dizi.add(dai4);
        
        Dikdortgen dik1= (Dikdortgen) dizi.get(1);
        
        Dikdortgen dik2 = (Dikdortgen) dizi.get(6);
        Dikdortgen dik3 = new Dikdortgen(dik2); //copy constructor
        dizi.add(dik3);
        
        Silindir sil1 = (Silindir) dizi.get(4);
        
        Silindir sil2 = (Silindir) dizi.get(5);
